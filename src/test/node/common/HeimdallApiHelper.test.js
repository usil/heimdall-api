...
describe('HeimdallApiHelper : getPermissionsByStringRoute', function () {
    ...
    test('should get return the permission by route', async function () {
    ...
    test('should get return empty if @Protected is not used', async function () {
        var heimdallApiHelper = new HeimdallApiHelper();
    ...
    test('should get return a custom error on exception', async function () {
        var heimdallApiHelper = new HeimdallApiHelper();
        try {
            var permissionsByStringRoute = heimdallApiHelper.getPermissionsByStringRoute(JSON.parse("{}"));
        } catch (err) {
